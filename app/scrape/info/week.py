...
def week_lesson_info(day: Day, dt: datetime.datetime = None):
    """
...
def week_lessons_overview(day: Day, dt: datetime.datetime = None):
    lessons = []
...
def week_info(day: Day, dt: datetime.datetime = None):
    return {
        "date": {
            "day": day.date,
        ...
        "lesson-info": week_lesson_info(day, dt),
        "lesson-overview": week_lessons_overview(day, dt),
        "lessons": day.lessons
    }
